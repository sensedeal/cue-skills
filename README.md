...
| [`cue-section-registration/`](./cue-section-registration) — **cue-section-registration** | Manager DD 「登记与合规」 section: AMAC → ≤3 judgments + boundaries → create/merge draft shell in user workspace; blocks overclaim phrases. | v0.1.0 |
