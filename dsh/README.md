...
The **Omni Reader** wiring bundle pins the audited Bridge `@cueai/omni-reader-mcp@1.8.3` (never an implicit `latest`). To pin another audited release, edit that bundle's `cordis.patch.yml` (see its `README.md`).
