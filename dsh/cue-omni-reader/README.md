...
- The Bridge is spawned via `npx -y @cueai/omni-reader-mcp@1.7.3`, so the npm registry
...
- Bridge pin: **`@cueai/omni-reader-mcp@1.7.3`** (audited; never an implicit `latest`).
