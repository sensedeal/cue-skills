...
- The Bridge is spawned via `npx -y @cueai/omni-reader-mcp@1.8.2`, so the npm registry
...
- Bridge pin: **`@cueai/omni-reader-mcp@1.8.2`** (audited; never an implicit `latest`).
