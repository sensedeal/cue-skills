...
- The Bridge is spawned via `npx -y @cueai/omni-reader-mcp@1.8.0`, so the npm registry
...
- Bridge pin: **`@cueai/omni-reader-mcp@1.8.0`** (audited; never an implicit `latest`).
