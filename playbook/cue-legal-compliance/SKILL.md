...
description: >
  用 Cue 跑「法律合规」场景的深度研究：多源公开数据交叉、结论带来源。
  Run Cue deep research for the "Legal & Compliance" scenario.
  触发 Triggers: 法律合规、信披与监管、企业尽调 / legal compliance, statute lookup, regulatory penalty
license: MIT
metadata:
...
## 当前可用搭子（仅供理解；运行时以 live 为准）
  ...
  - 创新药政务资助项目挖掘：基于政府主管部门、基金委、立项公示和企业正式披露，核验创新药细分赛道的申报指南、立项与实际拨付。严格区分指南方向、平均资
  - 药企跨境合规诊断报告：对药企出海管线开展HGRAC、数据出境、出口管制、地缘政治、IP权属及交易结构六维公开信息初筛，定位需企业补证或由专业律
