...
_EXPECTED_BRIDGE_VERSION = "1.8.1"
_CURRENT_PUBLICATION_REPORT = "2026-09-22-bridge-1.8.1-published.md"
...
class TestReferences(unittest.TestCase):
    ...
    def test_setup_documents_exact_trusted_uninstall_entries(self) -> None:
        expected = (
            "Uninstall removes a normal trusted 1.8.0 or 1.8.1 Bridge entry; it "
        ...
        self.assertNotIn(
            "Uninstall removes a normal trusted 1.7.3 or 1.8.0 Bridge entry",
            self.setup,
        )
    ...
    def test_current_publication_report_records_verified_1_8_1_release(self) -> None:
        current = _required_text(self, _REPORTS_DIR / _CURRENT_PUBLICATION_REPORT)
