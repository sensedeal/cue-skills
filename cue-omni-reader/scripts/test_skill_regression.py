...
class TestReferences(unittest.TestCase):
    ...
    def test_setup_pins_the_audited_bridge_and_node(self) -> None:
        self.assertIn("@cueai/omni-reader-mcp@1.3.0", self.setup)
        self.assertIn("Node.js 20.12", self.setup)
        self.assertIn("npx -y @cueai/omni-reader-mcp@1.3.0 setup", self.setup)
        self.assertIn("npx -y @cueai/omni-reader-mcp@1.3.0 doctor --json", self.setup)
        self.assertIn(
    ...
    def test_versions_match_across_skill_setup_and_current_reports(self) -> None:
        ...
        current = _required_text(self, _REPORTS_DIR / "2026-08-17-bridge-1.3.0-published.md")
    ...
    def test_compatibility_is_versioned_and_evidence_scoped(self) -> None:
        ...
        self.assertIn("Bridge version: `1.3.0`", self.compat)
