...
- [Bridge 1.8.3](2026-09-23-bridge-1.8.3-published.md) — pin-sync release; data-plane error codes renamed to `OMNI_READER_*` / `INSECURE_OMNI_READER_URL` (hard cut, no alias); publication pending owner 2FA publish.
